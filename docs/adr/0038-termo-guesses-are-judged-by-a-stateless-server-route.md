...
- **(f) The abuse posture is stated here rather than inherited, and it is
  ...
  *(**Amended at #31** —
  ...
  ritual"* — stop being true: every published past Termo is now playable at
  its own URL, so the route's legitimate volume is six times however many
  archived Termos a player opens. The **posture is unchanged**: still no rate
