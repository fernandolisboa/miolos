...
**Amended by:** [ADR-0067](./0067-termo-accent-deepens-to-carry-a-light-label.md) (#161) — `--accent-termo` deepened `#C08A1E` → `#8D6212`, so the done-chip and postmark decorative-exemption worst cases quoted here at 2.8501:1 (card) and 2.7311:1 (desk) are now 5.0542:1 and 4.8433:1; every accent ring clears WCAG 1.4.11's 3:1 unaided and the exemption argument is headroom, not load-bearing. The chip's anatomy, geometry and everything else decided here is untouched.
