...
**Amended by:** [ADR-0084](./0084-the-answer-list-alert-rides-the-buffer-depth-poll.md) — decision 5 does not apply to the `answer-list-alert` label
...
`T-WEB-S233` in `apps/web/test/fanout-cap.test.ts` scans the workflow: it exists,
