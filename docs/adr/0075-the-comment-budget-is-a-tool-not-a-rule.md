...
- The tracked surface went to **0.1%**, with no file over budget. Run `pnpm comments` for the current number rather than trusting this line — that is the whole point of the decision above, and two figures in an earlier draft of this ADR were wrong.
