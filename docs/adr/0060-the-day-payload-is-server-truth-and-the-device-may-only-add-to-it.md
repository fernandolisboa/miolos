...
**Amended at #143** (Tier 2 at reduced ceremony — no plan document; the plan and its records section live in the PR body, per the #103 precedent) — **(a), a decision-level amendment**: decision 5's no-interval clause is superseded by a bounded visible-tab poll. The clause's own revisit trigger — *"a complaint, not a schedule"* — fired: Fernando asked, answering PR #135 veto decision 4. Annotated in place; nothing deleted.
