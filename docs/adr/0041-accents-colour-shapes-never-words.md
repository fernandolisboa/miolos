...
**Amended by:** [ADR-0080](./0080-paper-dark-accents-lighten-under-a-paper-label.md) — decision 1's accent-as-text allowance and consequence (h)'s site figures are now measured in the dark palette too, and accent-coloured text is barred from `--paper-tint` in dark, where every accent clears only 4.24–4.26:1.
