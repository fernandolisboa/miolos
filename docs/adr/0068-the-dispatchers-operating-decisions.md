...
**Amended by:** [ADR-0083](./0083-the-email-hedge-is-a-second-arm-of-the-one-tick.md) — decisions 4 and 5 (per-channel response, 503 on either transport, the concurrency trigger summed over both arms) and the consequence that the push reader stays untouched
