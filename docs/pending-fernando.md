...
- **Do it before anyone but you gets reminder emails.** The email arm (#199) is live, and its link opens `/ajustes`, which has no checkbox to stop it until the second PR ships. Applying the columns is safe any time: they are new and nullable, and nothing reads them until that PR ships.
