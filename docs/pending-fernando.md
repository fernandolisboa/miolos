...
## NOW — one ⚡ decision that is not urgent
...
|---|---|---|
| Migration 0012 on Neon — the two consent-withdrawal columns for #36's second PR | NOW §2, 2026-09-24 | 2026-09-25: Fernando reported the two ALTER TABLE lines applied on the Miolos production database, in the #36 project thread, 2026-09-25 16:46Z (a first run hit another project's database by mistake) |
| #199 how people stop the email reminder | NOW §2, 2026-09-24 | Fernando 2026-09-24 on the #199 thread: never by writing an email; it must be a user setting (a checkbox). The checkbox is #36's second PR. PR #268 merged first on 2026-09-25 by Fernando's call, while he is the only recipient (ADR-0083 decision 6) |
