...
- **Source:** #36 plan, 2026-09-24; [ADR-0082](./adr/0082-settings-withdraws-consent-with-timestamps-removing-the-email-is-the-recovery-withdrawal.md). If #199 lands a migration first, the file number moves; the two statements do not.
