...
```
Read docs/handoffs/063-handoff-the-three-activations.md, then
docs/pending-fernando.md.

PREFLIGHT: main = 622e857; #178-#186 merged; no open PRs; NOW EMPTY;
#64/#32/#104 open; ADR-0070 reserved for #64. On mismatch: stop and
read the newest addendum first.

Nothing pends on Fernando — do not offer him credential work.
Frontier: #64 FIRST, starting at STEP 5 (steps 1-3 are in
docs/plans/066; ships ADR-0070), then #104, #149, #155, #106, #74.
#32's email-hedge slice is newly unblocked.
