...
| `plans/015-issue-39-plan-impeccable-ci.md` | Implementation plan for #39 (impeccable detect against Vercel preview deployments in CI); 014 is reserved by a parallel stream (#17) and lands with its own PR |
