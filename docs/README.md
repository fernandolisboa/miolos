...
| `plans/015-issue-39-plan-impeccable-ci.md` | Implementation plan for #39 (impeccable detect against Vercel preview deployments in CI); 014 and 016 are reserved by parallel streams (#17, #43) and land with their own PRs |
