...
| **Validation dictionary** | Lista de palavras aceitas | The 5 310 words a guess may be (`TERMO_VALIDATION_WORDS`). Public by design — it ships to the client so "não está na lista" is instant and offline. A superset of the answer list in normalized form. |
