...
/**
 * The discreet count-up readout. Two of these render at once — one in the
 * mobile top bar, one in the desktop stats card — because the responsive
 * reflow moves the readout across subtrees, which no CSS (and certainly
 * not `display: contents`) can do. The media queries in the module hide
 * exactly one of the pair, and `display: none` removes it from the
 * accessibility tree too, so a real browser exposes one timer.
 *
