...
// A generated file's header is its generator's to write, and editing one is
// undone by the next run. Reported as SKIPPED rather than passed silently:
// a budget that quietly excluded files would be the reassuring output #205's
// Rule I is about.
