...
// 3% of a 30-line file is zero, which would forbid CLAUDE.md's sanctioned
// comments outright — see ADR-0075.
const FLOOR_LINES = 2;

// The one list — see ADR-0075. `selftest.mjs` iterates it AND pins the label
// set separately, so neither adding nor deleting a member goes untested.
